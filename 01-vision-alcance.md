...
| S6 | El proveedor de IA para todas las funcionalidades (normalización, detección de duplicados, lectura de padrones, chatbot) es la API de Gemini (Google AI Studio) — **corregido el 2026-08-02**, era Anthropic (Claude) hasta que la cuenta se quedó sin saldo en medio de una carga real de padrón; Gemini tiene cuota gratuita suficiente para el volumen real de ATP | Alto: cambiar de proveedor implica revisar todo [`15-ia.md`](./15-ia.md) | [`15-ia.md`](./15-ia.md) |
