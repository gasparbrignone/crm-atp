...
**Estado actual (2026-08-04): fase de construcción, sin datos reales de terceros cargados todavía** — el único dato personal en la base es el del propio Gaspar, para pruebas. Esto importa para calibrar el peso real de las secciones de seguridad/legales de este archivo y de `16-seguridad.md`: el checklist de la sección 13 de ese documento (RLS real, MFA, rotación de credenciales, separación dev/prod, simulacro de backup) es la condición de salida de esta etapa — se aplica antes de cargar el primer dato real de un tercero, no como una restricción activa hoy sobre el ritmo de desarrollo. Ver el análisis completo en `REVISION-CRITICA-AUDITORIA-2026-08-04.md` sección 0. Este marcador debe borrarse (y recién ahí el checklist pasa a ser una restricción activa) el día que se cargue el primer dato real de un tercero.
