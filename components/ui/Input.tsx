    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className={cn(
            "min-h-11 rounded-borde-chico border border-borde bg-fondo-superficie px-3 text-sm text-texto placeholder:text-texto-secundario transition-colors focus:border-secundario focus:outline focus:outline-2 focus:outline-offset-0 focus:outline-secundario/30 disabled:opacity-50",
