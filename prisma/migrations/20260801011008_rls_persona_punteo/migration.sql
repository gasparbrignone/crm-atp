...
--
-- CÓMO APLICAR (una vez que exista una migración inicial contra Supabase real):
--   1. npx prisma migrate dev --name init            (genera la migración base desde schema.prisma)
...
--   4. npx prisma migrate dev                         (aplica la migración con el SQL de RLS)
--
-- No se aplica automáticamente: se deja como archivo de referencia hasta que
-- exista una base de Supabase real contra la cual migrar.
